...
import "./embla.css";
import brand1 from "/images/slider/brand_1.png";
...
export default function CourseSlider(props) {
  ...
  const SLIDES = [
    { src: brand1, alt: "brand1", link: "#" },
    { src: brand2, alt: "brand2", link: "#" },
    { src: brand3, alt: "brand3", link: "#" },
    { src: brand4, alt: "brand4", link: "#" },
    { src: brand5, alt: "brand5", link: "#" },
    { src: brand1, alt: "brand1", link: "#" },
    { src: brand2, alt: "brand2", link: "#" },
    { src: brand3, alt: "brand3", link: "#" },
    { src: brand4, alt: "brand4", link: "#" },
