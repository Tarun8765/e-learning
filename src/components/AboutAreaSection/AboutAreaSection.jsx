...
function AboutAreaSection() {
  return (
    <section className="about_area tg-motion-effect">
      <div className="container">
        <div className="row d-flex align-items-center justify-content-center ">
          <div className="col-lg-6 col-md-9 ">
            <div className="about_images position-relative">
              <img src="/images/about_img.png" alt="img" className="main-img" />
              <img
                src="/images/about_shape.svg"
              ...
              <div className="about_enrolled aos-init aos-animate">
                <p className="title">
                  <span>36k+</span>
                  Enrolled Students
                </p>
                <img src="/images/student_grp.png" alt="img" />
              </div>
            </div>
          </div>
          <div className="col-lg-6">
            <div className="about_content">
              {/* <CourseHead
                ...
                title={"Thousand Of TopNow in One Place"}
              /> */}
              ...
              <p className="decs">
                ...
                to organize, prioritize and.In this episode of the Smashing Pod
                we're talking about Web Platform Baseline.
              </p>
